...
param=$1
python /s/ls4/users/aamore/rl_a3c_pytorch/src/main.py /s/ls4/users/aamore/rl_a3c_pytorch/configs/run_config_our8.ini ${param} | tee mytask_logs/mytask.log."$SLURM_JOBID"
