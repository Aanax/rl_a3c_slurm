...
EVAL_CMD="python /s/ls4/users/dartl0l/goarl/rl_a3c_slurm/src/eval.py --config ${CONFIG} --model-path ${MODEL_PATH} --on-cluster"
...
# Run evaluation
${EVAL_CMD} | tee /s/ls4/users/dartl0l/rl_a3c_slurm/logs/eval."${SLURM_JOBID}".log
