...
class Hierarchial_memory_action_memrelu(nn.Module):
    ...
    def __init__(self, num_inputs, action_space, args):
        ...
        # Additional memory for A2 (action memory with gamma2)
        self.running_memory_action2 = torch.zeros((1, self.num_outputs))
...
class Hierarchial_memory_action_memrelu2(nn.Module):
    """
    Same as Hierarchial_memory_memrelu but with action memory added.
